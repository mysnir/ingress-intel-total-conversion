// ==UserScript==
// @id             ingress-intel-total-conversion@mysnir
// @name           IITC: Ingress intel map total conversion
// @version        0.24.1.20150805.203419
// @namespace      https://github.com/mysnir/ingress-intel-total-conversion
// @updateURL      https://github.com/mysnir/ingress-intel-total-conversion/raw/master/total-conversion-build.meta.js
// @downloadURL    https://github.com/mysnir/ingress-intel-total-conversion/raw/master/total-conversion-build.user.js
// @description    [local-2015-08-05-203419] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2015-08-05-203419';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2015-08-05-203419');
  ...
  if(window.bootPlugins) {
    ...
    if (Object.keys(badPlugins).length > 0) {
      ...
      warning += '</ul><p>Please uninstall the problem plugins and reload the page. See this <a href="http://mysnir.no-ip.org">FAQ entry</a> for help.</p><p><i>Note: It is tricky for IITC to safely disable just problem plugins</i></p>';
...
var script = document.createElement('script');
var info = { buildName: 'local', dateTimeVersion: '20150805.203419' };
